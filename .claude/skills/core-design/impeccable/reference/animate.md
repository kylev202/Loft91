...
- react-three-fiber (@react-three/fiber) for WebGL scenes and 3D animation in React
- @shadergradient/react for animated 3D shader gradient backgrounds/hero surfaces
```
