/**
 * sync-assets.mjs — mirror the generated asset derivatives into demo2/public.
 *
 ...
 *
 * `demo2/public/` is generated output. Never hand-edit it; edit `assets/` and
...
console.log('sync-assets: assets/img/opt + assets/fonts -> demo2/public');
