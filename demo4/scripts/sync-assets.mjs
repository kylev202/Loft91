/**
 * sync-assets.mjs — mirror the generated asset derivatives into demo4/public.
 *
 ...
 *
 * `demo4/public/` is generated output. Never hand-edit it; edit `assets/` and
...
console.log('sync-assets: assets/img/opt + assets/fonts -> demo4/public');
