 ...
 *
 * The Gallery *page* runs the same seven frames as a full monograph sequence
 * (`Plates`). This is the home page's version of it: the same photographs, in
 * the same order, laid along one horizontal scroller you can flick through in
 * a second without leaving the index page.
 *
 ...
 * read as a contact sheet rather than as a carousel.
 *
